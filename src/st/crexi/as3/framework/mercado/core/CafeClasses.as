package st.crexi.as3.framework.mercado.core
{
	internal class CafeClasses
	{
		...
		import st.crexi.as3.framework.cafe.core.AbstDependencies; AbstDependencies;
		
		import st.crexi.as3.framework.cafe.core.interfaces.IDependencies; IDependencies;
		import st.crexi.as3.framework.cafe.core.interfaces.IRecipe; IRecipe;
		import st.crexi.as3.framework.cafe.core.interfaces.IRequest; IRequest;
